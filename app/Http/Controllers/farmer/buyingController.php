...
class buyingController extends Controller
{
   public function index(){
      ...
      $check = cart::where('user_id',auth()->user()->id)
        ...
        return view('farmer.buyingProducts',['items'=>$items,'count'=>$count]);
        
       // $products = (new retailor_products())->getretailorProducts();
       // return view('farmer.buyingProducts',['products'=>$products]);
    ...
    function deleteCartItem($cartId){
     ...
     public function getFarmerBuyingOrders(){
        $orders = (new order_t())->getFarmerBuyingOrders();
        return view('farmer.buyingorders',['orders'=>$orders]);
    }
}
