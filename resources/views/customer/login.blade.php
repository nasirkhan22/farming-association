        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <form method="POST" action="{{ route('login') }}" class="md-float-material form-material">
                    @csrf
                    <input type="text" value="4" name="role" hidden>
                    ...
                    <div class="auth-box card">
                        <div class="card-block">
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    <h3 class="text-center">Customer Sign In</h3>
                                </div>
                            </div>
                            @if (session('error'))
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <p class="text-inverse text-left"><a href="{{route('customer.register')}}"><b>Register as new</b></a></p>
                                </div>
                                <div class="col-md-2">
