                    ...
                    <div class="auth-box card">
                        <div class="card-block">
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    <h3 class="text-center">Retailor Sign In</h3>
                                </div>
                            </div>
                            @if (session('error'))
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <p class="text-inverse text-left"><a href="{{route('retailor.register')}}"><b>Register as new</b></a></p>
                                </div>
                                <div class="col-md-2">
