                                ...
                                @foreach($orders as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <a href="updateStatus/{{$row->id}}/assigned">  <button class="btn btn-success">Accept</button></a>
                                           @endif
                                           @if($row->status=='assign')
                                           <a href="updateStatus/{{$row->id}}/completed"><button class="btn btn-secondary">Complete</button></a>
