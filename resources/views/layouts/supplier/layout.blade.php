                ...
                <nav class="pcoded-navbar">
                    ...
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="active">
                                <a href="{{ route('supplier.home') }}" class="waves-effect waves-dark">
                            ...
                            <li class="">
                                <a href="{{ route('supplier.requests') }}" class="waves-effect waves-dark">
                            ...
                            <li class="">
                                <a href="{{ route('supplier.active.deliveries') }}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-list"></i><b></b></span>
                                    <span class="pcoded-mtext" data-i18n="nav.dash.main">Active Deliveries</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>

                            <li class="">
                                <a href="{{ route('supplier.completed.deliveries') }}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-list"></i><b></b></span>
                                    <span class="pcoded-mtext" data-i18n="nav.dash.main">Completed Deliveries</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                        </ul>
