                ...
                <nav class="pcoded-navbar">
                    ...
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="active">
                                <a href="{{ route('customer.home') }}" class="waves-effect waves-dark">
                            ...
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=" ">
                                        <a href="{{ route('customer.retailor.products') }}" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Retailor</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                    <li class=" ">
                                        <a href="{{route('customer.farmer.products')}}" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Farmer</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                        ...
                        <div class="pcoded-navigation-label" data-i18n="nav.category.forms">Orders</div>
                          <li class=" ">
                                <a href="{{route('customer.orders')}}" class="waves-effect waves-dark">
