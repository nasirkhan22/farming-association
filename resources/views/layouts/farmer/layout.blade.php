            ...
            <div class="pcoded-wrapper">
                <nav class="pcoded-navbar">
                    ...
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=" ">
                                        <a href="{{ route('farmer.productCategories') }}" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Product Categories</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                    <li class=" ">
                                        <a href="{{route('farmer.items')}}" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Product Items</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class=" ">
                                <a href="{{route('farmer.buying.products')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-list"></i><b>FC</b></span>
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Retailor Products</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>

                            <li class=" ">
                                <a href="{{route('farmer.buyingorders')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-list"></i><b>FC</b></span>
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li>
                                <a href="{{route('farmer.orders')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">New Orders</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>

                            <li>
                                <a href="{{route('farmer.activeorders')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Active Orders</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                              <li>
                                <a href="{{route('farmer.completedorders')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Completed Orders</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                              <li>
                                <a href="{{route('farmer.cancelledorders')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Rejected Orders</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('farmer.orderhistory')}}" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
